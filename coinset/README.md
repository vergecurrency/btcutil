...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vergecurrency/btcutil/coinset)
...
```bash
$ go get -u github.com/vergecurrency/btcutil/coinset
```
